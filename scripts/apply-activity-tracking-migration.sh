...
# Apply Activity Tracking Migration
# Date: 2025-02-04
...
echo "📦 Applying Activity Tracking Migration..."
echo ""

# Read the SQL file
SQL_FILE="/Users/stuartholmes/Desktop/Udemy & Other Courses/The Complete AI Coding Course - August 2025/project-genie/supabase/migrations/20250204_create_activity_tracking_system.sql"
...
echo ""
echo "🎉 Activity tracking system is now set up!"