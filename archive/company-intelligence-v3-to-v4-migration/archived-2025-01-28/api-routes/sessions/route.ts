/**
 * @deprecated [2025-01-28] - V3 Legacy Route
 * @migration Company Intelligence V3 → V4 Migration
 * @replaced-by /api/company-intelligence/v4/intelligence
 * @reason Replaced with V4 architecture using CompanyIntelligenceRepositoryV4
 * @last-used Company Intelligence dashboard before V4 refactor
 * @can-delete-after 2025-03-01 (60 days validation period)
 *
 * ARCHIVE NOTE: This was part of the V3 Company Intelligence implementation
 * that used the original CompanyIntelligenceRepository. V4 uses a new repository
 * with improved session management and unified event streaming.
 * Keep for reference if rollback needed or to understand V3→V4 differences.
 */
