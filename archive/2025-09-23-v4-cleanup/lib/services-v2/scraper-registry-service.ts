...
export class ScraperRegistryService {
  ...
  constructor() {
    ...
    permanentLogger.info('SCRAPER_REGISTRY_SERVICE', 'Service initialized', { scrapersDiscovered: this.scrapers.size})
  }
  ...
  private autoDiscoverScrapers(): void {
    ...
    permanentLogger.info('SCRAPER_REGISTRY_SERVICE', 'Scrapers discovered', {
