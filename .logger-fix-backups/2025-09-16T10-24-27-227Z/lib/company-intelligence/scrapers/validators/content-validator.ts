...
export class ContentValidator {
  ...
  public validate(scrapedData: any): ValidationResult {
    ...
    permanentLogger.info('🔍 Starting content validation', { category: 'CONTENT_VALIDATOR', url: scrapedData.url,
  ...
  public validateBatch(scrapedPages: any[]): {
    ...
    permanentLogger.info('✅ Batch validation complete', { category: 'CONTENT_VALIDATOR',
      ...stats,
