...
export function getStrategyForTechnology(technology: string): TechnologyMapping {
  ...
  permanentLogger.info('Mapping technology to strategy', { category: 'STRATEGY_MAPPING',
  ...
  permanentLogger.info('Strategy selected for technology', { category: 'STRATEGY_MAPPING', technology,
...
export function groupPagesByStrategy(
  ...
  permanentLogger.info('Starting page grouping', { category: 'STRATEGY_GROUPING', totalPages: pages.length,
  ...
  if (siteAnalysisData?.siteType) {
    ...
    if (mapping.strategy === 'hybrid') {
      ...
      permanentLogger.info('Hybrid site pages analyzed', { category: 'STRATEGY_GROUPING', staticPages: groups.static.length,
        dynamicPages: groups.dynamic.length })
    } else {
      // All pages use the same strategy
      groups[mapping.strategy] = [...pages]
      
      permanentLogger.info('All pages use same strategy', { category: 'STRATEGY_GROUPING', strategy: mapping.strategy,
    ...
    permanentLogger.info('Used URL heuristics (no site analysis)', { category: 'STRATEGY_GROUPING', staticPages: groups.static.length,
      dynamicPages: groups.dynamic.length })
  }
  
  // Log summary
  permanentLogger.info('Page grouping complete', { category: 'STRATEGY_GROUPING', static: groups.static.length,
