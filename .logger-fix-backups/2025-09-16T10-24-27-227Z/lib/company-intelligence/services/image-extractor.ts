...
export class ImageExtractor {
  ...
  async extractImages(options: ImageExtractionOptions): Promise<ExtractedImages> {
    ...
    permanentLogger.info('Starting image extraction', { category: 'IMAGE_EXTRACTOR', url,
      hasCheerio: !!$,
      hasPlaywright: !!page,
      maxImages })
    ...
    try {
      ...
      permanentLogger.info('Image extraction complete', { category: 'IMAGE_EXTRACTOR', url,
