...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (body.options?.stream) {
      permanentLogger.info('Starting streaming execution', { category: 'SCRAPING_API', sessionId: body.sessionId,
        mode: body.options.mode || 'static' })
      ...
      executor.executeWithStreaming(
        ...
        permanentLogger.info('Streaming completed', {
          category: 'SCRAPING_API',
          sessionId: body.sessionId,
    ...
    permanentLogger.info('Starting standard execution', { category: 'SCRAPING_API', sessionId: body.sessionId,
      mode: body.options?.mode || 'static' })
