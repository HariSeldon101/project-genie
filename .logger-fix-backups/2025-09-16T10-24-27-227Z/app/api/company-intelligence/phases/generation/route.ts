...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (!enrichmentReview.approved) {
      permanentLogger.info('Enrichment results did not meet quality threshold', { category: 'GENERATION_ENDPOINT', sessionId,
    ...
    permanentLogger.info('⚠️ STARTING DOCUMENT GENERATION WITH LLM CALLS ⚠️', { category: 'GENERATION_ENDPOINT', sessionId,
    ...
    permanentLogger.info('Generation phase completed', {
      category: 'GENERATION_ENDPOINT',
      sessionId,
    ...
    permanentLogger.info('✅ FULL PIPELINE COMPLETED', { category: 'GENERATION_ENDPOINT', sessionId,
